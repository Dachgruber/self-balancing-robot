...
Die Schrittmotor-Treiber sind über die eingebauten Trimm-Potentiometer auf einen Betriebsstrom von ca 1.1A eingestellt worden. Zusätzlich wurden die Treiber-Controller mit einem 6mm Aluminium Passivkühler versehen, um auch im längeren Betrieb eine einigermaßen geeignete Betriebstemperatur zu gewährleisten.\\
...
\begin{enumerate}
\item das einfache Addieren beider Messergebnisse ohne Berücksichtigen der Fehlerquellen (Vogel-Strauß-Methode nach Tanenbaum)\cite{AndrewS.Tanenbaum.2009,Wikipedia.2020}.\\
